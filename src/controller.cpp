...
void Controller::setRecaptchaResponse(const QString &recaptchaResponse)
{
    m_recaptchaResponse = recaptchaResponse;
    Q_EMIT recaptchaResponseChanged();
}

QString Controller::recaptchaResponse() const
{
    return m_recaptchaResponse;
}

void Controller::setRecaptchaSiteKey(const QString &recaptchaSiteKey)
{
    m_recaptchaSiteKey = recaptchaSiteKey;
    Q_EMIT recaptchaSiteKeyChanged();
}

QString Controller::recaptchaSiteKey() const
{
    return m_recaptchaSiteKey;
}

QVector<QVector<QString>> Controller::flows(const QString &homeserver) const
{
...
void Controller::registerAccount(const QString &homeserver, const QString &username, const QString &email, const QString &password)
{
    Connection *connection = new Connection;
    connection->setHomeserver(QUrl(homeserver));
...
void Controller::setTermsName(const QString& termsName)
{
    m_termsName = termsName;
    Q_EMIT termsNameChanged();
}

void Controller::setTermsUrl(const QString& termsUrl)
{
    m_termsUrl = termsUrl;
    Q_EMIT termsUrlChanged();
}

QString Controller::termsName() const
{
    return m_termsName;
}

QString Controller::termsUrl() const
{
    return m_termsUrl;
}
